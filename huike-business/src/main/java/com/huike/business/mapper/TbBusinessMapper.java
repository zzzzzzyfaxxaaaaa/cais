...
public interface TbBusinessMapper {
    ...
    List<Map<String, Object>> countAllContractByUser(@Param("indexVo") IndexStatisticsVo request);

    int countAllBusiness(@Param("beginCreateTime") String beginCreateTime,@Param("endCreateTime") String endCreateTime);
