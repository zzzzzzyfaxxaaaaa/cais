...
public interface TbClueMapper {
     ...
     * @return
     */
    Integer countAllClues(@Param("beginCreateTime") String beginCreateTime, @Param("endCreateTime") String endCreateTime);
     ...
     * @return
     */
    Integer effectiveCluesNums(@Param("beginCreateTime") String beginCreateTime, @Param("endCreateTime") String endCreateTime);
}